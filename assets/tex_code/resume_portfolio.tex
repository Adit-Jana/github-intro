...
\begin{document}
    ...
    \vspace{0.1 cm}
        \begin{onecolentry}
            \begin{highlights}
                \item {Authored and published the research paper \textbf{“Automated Attendance System Using Face Recognition”} in International Journal of Engineering and Applied Sciences (IJEAS), Vol. 5, Issue 7, July 2018.}
...
% format by https://www.overleaf.com/
% scored by https://resumeworded.com/