...
\begin{document}
    ...
    \spacing{1.2}
        %\begin{Center}
        % \textbf{Senior Software Developer} with \textbf{6} years of experience engineering in \textbf{Java} and \textbf{Spring Boot} \textbf{Microservices} for international clients. Spearheaded migration of a mainframe application to AWS-hosted microservices, enhancing response times by \textbf{40\%} and slashing idle resource usage by \textbf{60\%}. Engineered RESTful APIs and messaging workflows (RabbitMQ, AWS SQS) to support an average of \textbf{ 10,000+} daily users. Proficient in PostgreSQL, Redis, Docker  and CI/CD pipelines. Deployed performance monitoring frameworks (Elasticsearch, Logstash, Kibana, New Relic, Datadog), optimizing operational efficiency.
    ...
    \vspace{0.1 cm}
        ...
        % \end{onecolentry}
        % \begin{onecolentry}
        % \textbf{Methodologies \& Tools:}  Agile (Scrum), SDLC, Jira % \end{onecolentry}
        % \vspace{0.1 cm}
        \begin{onecolentry}
